...
public class CurrencyConverter {
	...
	public static void Dollar_to_other(double amt) {
		...
		System.out.println("1 Dollar = " + 134.04 + " Yen");
		System.out.println();

		System.out.println(amt + " Dollar = " + (amt * 134.04) + " Yen");
	}
	...
	public static void Euro_to_other(double amt) {
		...
		System.out.println("1 Euro = " + 147.53 + " Yen");
		System.out.println();

		System.out.println(amt + " Euro = " + (amt * 147.53) + " Yen");
	}
