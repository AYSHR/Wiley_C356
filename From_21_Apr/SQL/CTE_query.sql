...
insert into tasks(title,priority) values("task 1",default);

insert into tasks(title,priority,startdate) values("task 1",default,current_date());
-- ---
...
-- to check how many values acn be added
show variables like "max_allowed_packet";

--
-- set global max_allowed_priority=size;
...
-- data from rooms will also be deleted
